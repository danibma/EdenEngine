...
// DISCLAIMER: This is a modified version of this repo https://github.com/simco50/CppDelegates, made by Simon Coenen
...
public:
	...
	{
		ensureMsg(m_Allocator.HasAllocation(), "Delegate is not bound");
